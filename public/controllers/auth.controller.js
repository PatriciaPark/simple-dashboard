...
exports.getOne = (req, res) => {
  console.log("************************controller email 1" + req.params.email + " " + res.session.user.email);
  if(!req.body) req.params.email = res.session.user.email;
  console.log("************************controller email 2" + req.params.email);
